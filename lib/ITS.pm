...
sub _getIts {
    ...
    my $sql = "select pr.proposal_id, pr.title, pr.principal_investigator_name, pr.principal_investigator_id, sq.taxonomy_info_id, sq.sequencing_project_id
from 
dw.proposal pr, 
...
#    print "numRows: $numRows\n";
    ...
    my ($propId,$title,$inv,$invId,$taxId,$proj_id) = $sth->fetchrow_array;
